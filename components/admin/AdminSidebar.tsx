...
const ADMIN_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: "Mkt",
    items: [
      { label: "Services", href: "/admin/services", icon: "Svc" },
      {
        label: "Service Requests",
        href: "/admin/service-requests",
        icon: "Req",
      },
      { label: "Rentals", href: "/admin/rentals", icon: "Rnt" },
      { label: "Blogs", href: "/admin/blogs", icon: "Blog" },
    ],
  },
  {
    id: "workforce",
    ...
    items: [
      ...
      { label: "Screenings", href: "/admin/workspace/screenings", icon: "Scr" },
      { label: "Projects", href: "/admin/workspace/projects", icon: "Prj" },
      {
  ...
  },
  {
    ...
    icon: "Fin",
    items: [
      { label: "User Wallets", href: "/admin/wallet", icon: "Wal" },
      { label: "Affiliates", href: "/admin/affiliates", icon: "Aff" },
      { label: "Payments", href: "/admin/payments", icon: "Pay" },
    ],
  },
  {
    id: "system",
    ...
    icon: "Sys",
    items: [
      { label: "Analytics", href: "/admin/analytics", icon: "Ana" },
      { label: "JarvisX AI", href: "/admin/jarvisx", icon: "AI" },
      { label: "Campaigns", href: "/admin/campaigns", icon: "Camp" },
