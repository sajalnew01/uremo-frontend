...
export default function JarvisXWriteError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[JARVISX_WRITE_PAGE_ERROR]", error);
  }, [error]);
    ...
    <div className="max-w-2xl py-8">
      <div className="rounded-2xl border border-red-500/30 bg-red-500/10 p-6">
        ...
        <p className="text-slate-300 mt-3">
          JarvisX Write encountered an error. This may be due to a temporary
          backend issue or network problem.
        </p>
